...
> **追加修复（同一次安装包内，2026-09-22，共十六条）**：下面十六条是打包后被主人实测报出来的，前五条已修进这一版的两个安装包，后面十一条是当晚第二到第九轮的线上修复（把图发出去四轮 + 私聊卡住的根因一轮 + 文件类型标记与 NapCat 界面鉴权各一轮 + 群里认人认主人与人设切换一轮 + 收尾那句 OK 与表情包参数各一轮 + NapCat 登录额度一轮）。
>
