...
const LABEL: Record<string, string> = {
  ...
  // 发送节奏
  burstEnabled: '允许连发', burstMaxMessages: '单次最多条数', burstIntervalMinMs: '连发最短间隔',
  burstIntervalMaxMs: '连发最长间隔', longGapProbability: '长停顿概率', longGapMinMs: '长停顿最短',
...
/** 进阶项说明（点 ⓘ 展开），只给对新手不友好的项加 */const HELP: Record<string, string> = {
  ...
  gapJitterRatio: '发送间隔抖动系数：越大越“不规律”，越小越机械。',
