 ...
 * @returns 本地时间字符串。
 */
export declare function formatCreatedAt(epochMs: number): string;
/**
 ...
 * @returns 单行节点文本。
 */
export declare function entryLine(entry: MemoryEntry): string;
/**
 * 由归一化条目渲染 9 列 Markdown 表格(表头 + 分隔行 + 每行一条)。
 * @param entries - 归一化后的记忆条目。
 * @returns 完整表格文本(末尾带一个换行)。
 */
export declare function renderMd(entries: readonly MemoryEntry[]): string;
/**
 ...
 */
export declare function renderSummary(entries: readonly MemoryEntry[]): string;
/**
 ...
 */
export declare const GLOBAL_INJECT_MAX = 30;
 ...
 * @returns 多行摘要文本,或空串。
 */
export declare function renderMemorySummary(entries: readonly MemoryEntry[], mode: SummaryMode, maxInject?: number): string;
